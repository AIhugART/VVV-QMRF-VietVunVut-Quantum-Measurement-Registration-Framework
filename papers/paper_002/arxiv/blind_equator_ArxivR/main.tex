...
$\rho_\mu = \mu|\Phi^-\rangle\langle\Phi^-| + (1-\mu)(|HV\rangle\langle HV| + |VH\rangle\langle VH|)/2$ for the
...
($15^\circ$--$75^\circ$) shows $\delta\langle AB\rangle = 0$ at all non-equatorial angles to within $\pm 0.003$
