...
| # | File | Content |
|---|------|---------|
| 1 | `figures/fig1_ewf_schematic.png` | EWF setup + tilted Superobserver |
| 2 | `figures/fig2_optical_path.png` | Optical path + QWP insertion |
| 3 | `figures/fig3_monte_carlo.png` | Monte Carlo: Gen LF 1 histogram |
...
**Claim A:** f_perp(+1,H) − f_perp(−1,H) = −cos θ = 0 at θ = π/2. All EWF experiments blind.
**Claim B:** Single QWP, θ = 31°. LF 8.6σ. β ≥ 0.07 (single) / β ≥ 0.04 (combined) at >5σ.

## Evolution

v1→v4→v8→v10→v11→**v12** (Eq.(12) bug fixed, exact numerics)
