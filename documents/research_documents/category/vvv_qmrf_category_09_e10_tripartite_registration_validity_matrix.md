...
**English:**
Standard QM already distinguishes physical interaction, decoherence, and measurement, but VVV-QMRF needs an explicit registration-validity boundary. The *Tripartite Validity Matrix* proposes three filters inspired by Buddhist Logic (*Trairūpya*):
...
**Vietnamese:**
QM tiêu chuẩn đã phân biệt tương tác vật lý, decoherence, và measurement, nhưng VVV-QMRF cần một ranh giới hợp lệ ghi nhận rõ ràng. *Ma trận Hợp lệ Ghi nhận Tam phân* đề xuất ba bộ lọc lấy cảm hứng từ Logic học Phật giáo (*Trairūpya*):
...
| §1 | BE source analogue | *Trairūpya* source anchor | N_BE_00018; support: N_BE_00210, N_BE_00211, N_BE_00212, N_BE_00213 | ED_BE_00008; ED_BE_00108; ED_BE_00109; ED_BE_00110 | Medium | Source lineage or analogy; do not collapse BE ontology into QM physics. |
...
2. **The BE source is bounded.** *Trairūpya* source anchor anchors the analogy or source lineage, but does not automatically become a QM mechanism.
...
BE source: *Trairūpya* source anchor.
...
```text
BE source analogue = *Trairūpya* source anchor.
QM substrate = measurement act, system-meter coupling, detector noise/fidelity, decoherence support.
...
2. **Not unrestricted equivalence with the BE source** — *Trairūpya* source anchor supplies source-lineage or analogy only within the stated boundary.
