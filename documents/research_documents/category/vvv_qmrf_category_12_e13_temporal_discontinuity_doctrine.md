...
flowchart TD
    subgraph BE["Buddhist Epistemology source layer"]
        BE1["*Kṣaṇabhaṅgavāda* source anchor"]
    end

    subgraph QM["Standard Quantum Measurement substrate"]
        QM1["Schrödinger evolution, wavefunction collapse, quantum jumps, Quantum Zeno effect, decoherence support"]
    end

    subgraph VVV["VVV-QMRF Registration Layer"]
        CAT["Category 12 / E13<br/>Temporal Discontinuity Doctrine / Moment-to-Moment Quantum Transition"]
        SYM["Discrete Transition Operator `T̂_kṣaṇa`"]
        BOUND["RCA boundary<br/>not that Schrödinger evolution is false and not that Buddhist momentariness is a physical proof of quantum jumps"]
    end
...
*Source: BIAN_index_SOT.md (BIAN-8), system_be_full.md (N_BE_00029), SYSTEM_Quantum_Measurement/system_qm_full.md, node_QM_VVV.md (N_QM_VVV_00051-00053), framework/E13_temporal_discontinuity_postulate.md*
