...
Lemma S1-Λ:
  Given E4 (∃ ε(M)) and E5 (∃ |Rₖ⟩_A):
    Λ: ε(M) → Ā(M) is the unique map satisfying:
      ...
      (iii)  Λ ∉ Ops(P)             — not a separate epistemic operation
...
S1 Pipeline (Epistemic Measurement Pipeline):
  ...
  └──────────────┬──────────────────────┘
                 ...
                 │    (Class A, not ENI — separate operation)
                 │
                 ▼
  ┌─────────────────────────────────────┐
  │  ③ V̂_yava — Commitment (E3)        │
  └──────────────┬──────────────────────┘
                 │
                 ▼
...
| 4 | Dignāga's count | Only 4 epistemic processes — no 5th for inter-stage transition | ❌ E8 |
...
| Document | Role | Path |
|----------|------|------|
| E4 Postulate | Λ operator origin | [E4](file:///c:/Stable_Diffusion/Buddhist_Epistemology_Quantum_Measurement/documents/research_documents/framework/E4_pre_symbolic_stratum_postulate.md) §3 |
| E5 Postulate | Ā(M) output domain | [E5](file:///c:/Stable_Diffusion/Buddhist_Epistemology_Quantum_Measurement/documents/research_documents/framework/E5_internal_encoding_postulate.md) §3 |
| S1 Pipeline | Integration site | [S1](file:///c:/Stable_Diffusion/Buddhist_Epistemology_Quantum_Measurement/documents/research_documents/synthesis/epistemic_measurement_pipeline.md) §4d |
