...
**Lineage:** framework/formal_registration_state_measurement_model.md â†’ framework/ (E17)
...
| Framework | formal_registration_state_measurement_model.md | Defines the two-level RCA boundary for measurement. |
...
|---|---|---|---|
| Lines 1-10 | Metadata and lineage | E17 belongs to VVV-QMRF and follows `formal_registration_state_measurement_model.md`. | Establishes traceability and prevents E17 from appearing as an isolated claim. |
...
*Source: framework/formal_registration_state_measurement_model.md, framework/vvv_qmrf_framework_e16_pre_measurement_registration_indeterminacy_postulate.md.*
