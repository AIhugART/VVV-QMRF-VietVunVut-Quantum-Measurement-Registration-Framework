...
- BIAN-10 — Non-Classical Correlation Relation. Quantum entanglement constitutes a type of inter-object relation that is neither identity-of-nature (tadaatmya) nor causal-production (tadutpatti). Buddhist Epistemology does not have a category for a non-causal, non-identity-based necessary correlation. This is a concept present in QM with no equivalent in Pramaanavada. (Note: this is the only BIAN in the mapping where the gap runs in the opposite direction — Buddhist Epistemology lacks a category that QM possesses.)
