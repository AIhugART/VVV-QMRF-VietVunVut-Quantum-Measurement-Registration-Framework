...
## Framework source: [bei_framework_4_axioms.md](Framework_Buddhist_Epistemology_Interpretation_of_Quantum_Measurement/bei_framework_4_axioms.md)
...
| 3 | Consciousness-Only | Vijñaptimātra (Skt.) | Consciousness (vijñāna) is the condition for reality to manifest. The object of cognition (ālambana) is nothing other than the appearance of an object in cognition itself. | Measurement does not reveal a pre-existing state — measurement is the condition for the state to manifest. Collapse is an epistemic update, not a physical event. |
...
| --- | --- | --- | --- |
| N_BE_29 | Kṣaṇabhaṅgavāda (Momentariness) | Ontology–cognition | Primary anchor: radical impermanence as the ontological basis of dependent arising |
| N_BE_21 | Svabhāvapratibandha (Essential relation) | Logic | Primary anchor: the two types of necessary relation (causal and identity) that ground inference |
| N_BE_20 | Avinābhāva (Necessary relation) | Logic | Primary anchor: "not-being-without" — the principle of inseparability between ground and consequence |
| N_BE_01 | Pramāṇa (Valid cognition) | Foundation | Relational validity: a cognition is valid only within its relational context |
| N_BE_19 | Vyāpti (Pervasion) | Logic | The logical relation of pervasion that depends on relational structure, not intrinsic essence |
| N_BE_16 | Liṅga / Hetu (Sign / Logical reason) | Logic | The inferential mark — knowledge derived from relational dependence between sign and signified |
| N_BE_18 | Trairūpya (Triple-condition syllogism) | Logic | Three conditions for valid reason — all defined relationally (presence in similar cases, absence in dissimilar) |
| N_BE_17 | Pakṣa (Thesis) | Logic | The locus where reason and probandum co-occur — defined by relational co-location |

## A1.2 — Core Mapping

### A1.2.1 — Momentariness and the Relational Foundation

- **Buddhist Epistemology:** N_BE_29 (Kṣaṇabhaṅgavāda) — "a moment disappears as soon as it appears without duration." The radical culmination of process philosophy. Rooted in the Buddha's dynamic law of dependent arising (pratītyasamutpāda). No entity persists across moments; what appears as continuity is a series of causally connected moments.
...
**Relevant edges:**
- ED_BE_34: N_BE_29 → N_BE_22 (supports — momentariness supports causal efficacy)
- ED_BE_35: N_BE_29 → N_BE_13 (characterizes — the particular is momentary)

### A1.2.2 — Essential Relation as the Ground of Dependence

- **Buddhist Epistemology:** N_BE_21 (Svabhāvapratibandha) — Dharmakīrti's innovation. Two types: tadutpatti (causality — relation between effect and cause) and tādātmya (identity — relation between two essentially common individuals). Replaces Dignāga's purely inductive vyāpti with a deductive, ontology-grounded relation. Things are connected not by logical convention but by ontological dependence.
- **Quantum Measurement:** Entanglement correlations and conservation-based correlations. The quantum state of a composite system is not factorable into independent states of subsystems. Conservation laws (e.g., angular momentum in pair production) ground correlations of the tadutpatti type; entanglement proper constitutes a third relation type — non-causal, non-identity-based necessary correlation — that has no formal equivalent in Buddhist Epistemology (see BIAN-10 in refine_mapping.md). Svabhāvapratibandha captures the two classical relation types; QM introduces a third.
- **Correspondence type:** Partial. Conservation-based correlations approximate tadutpatti/tādātmya. Entanglement proper exceeds both categories — it is a relation type present in QM with no BE equivalent (BIAN-10).

**Relevant edges:**
- ED_BE_11: N_BE_19 → N_BE_21 (grounded in — pervasion grounded in essential relation)
- ED_BE_12: N_BE_21 → N_BE_22 (has as basis — essential relation has causal efficacy as basis)

### A1.2.3 — Pramāṇa as Relational Validity

- **Buddhist Epistemology:** N_BE_01 (Pramāṇa) — validity is relational and functional, not intrinsic to any object or subject alone. Pramāṇa is the condition-event under which knowledge is certified. The four components (pramāṇa, pramā, prameya, pramāṇaphala) are relationally integrated — none functions independently.
...
**Relevant edges:**
- ED_BE_01: N_BE_01 → N_BE_02 (includes — pramāṇa encompasses pratyakṣa)
- ED_BE_02: N_BE_01 → N_BE_03 (includes — pramāṇa encompasses anumāna)
- ED_BE_03: N_BE_01 → N_BE_05 (has as object — pramāṇa directed toward prameya)
- ED_BE_04: N_BE_01 → pramāṇaphala (produces — the pramāṇa process culminates in resultant cognition as its outcome)

### A1.2.4 — Inference and the Logic of Dependence

- **Buddhist Epistemology:** N_BE_20 (Avinābhāva) — Vasubandhu's principle of "not-being-without": a property which does not occur without the probandum. N_BE_19 (Vyāpti) — Dignāga's pervasion: the logical relation between probans and probandum. N_BE_16 (Liṅga) — the sign that indicates the probandum through relational dependence. N_BE_18 (Trairūpya) — the three conditions all defined relationally (presence in sapakṣa, absence in vipakṣa).
...
**Relevant edges:**
- ED_BE_26: N_BE_20 → N_BE_19 (is precursor of — avinābhāva as precursor of vyāpti)
- ED_BE_10: N_BE_16 → N_BE_19 (requires — sign requires pervasion)
- ED_BE_09: N_BE_16 → N_BE_17 (qualifies — sign qualifies thesis subject)
- ED_BE_39: N_BE_16 → N_BE_20 (requires — sign requires necessary relation)
...
| --- | --- | --- | --- |
| N_BE_25 | Śūnyatā (Emptiness) | Ultimate object | Primary anchor: the absence of inherent existence in self and phenomena |
| N_BE_13 | Svalakṣaṇa (Particular / Unique mark) | Ontology–cognition | Primary anchor: the unique particular that possesses causal efficacy — the ultimately real |
| N_BE_14 | Sāmānyalakṣaṇa (Universal / General mark) | Ontology–cognition | Primary anchor: the conceptually constructed universal — empty of causal efficacy |
| N_BE_22 | Arthakriyā (Causal efficacy) | Ontology–cognition | Primary anchor: the criterion of reality — only causally efficacious entities exist ultimately |
| N_BE_05 | Prameya (Object of cognition) | Foundation | The object domain structured by the particular-universal duality |
| N_BE_15 | Apoha / Anyāpoha (Exclusion) | Philosophy of language | Meaning by exclusion — concepts are defined by what they are not, not by intrinsic content |
| N_BE_08 | Vikalpa / Kalpanā (Conceptual construction) | Mental structure | The mind's superimposition of categories onto bare perception — the source of imputed properties |
| N_BE_09 | Nirvikalpaka pratyakṣa (Non-conceptual perception) | Mental structure | Pure perception free from conceptual overlay — access to the particular without imputation |

## A2.2 — Core Mapping

### A2.2.1 — Emptiness as the Ground Principle

- **Buddhist Epistemology:** N_BE_25 (Śūnyatā) — the absence of inherent existence (niḥsvabhāvatā). Nāgārjuna's metaphysical essencelessness. No entity possesses svabhāva (own-being or intrinsic nature). What appears as a stable property is a conceptual imputation arising from relational conditions. Emptiness is not nihilism — it is the rejection of intrinsic nature as the ground of the conventional order.
...
**Relevant edges:**
- ED_BE_31: N_BE_25 → N_BE_26 (is ultimate aspect of — emptiness is the ultimate truth dimension)
- ED_BE_22: N_BE_12 → N_BE_25 (realizes — yogic perception realizes emptiness)
- ED_BE_30: N_BE_24 → N_BE_25 (realizes — wisdom realizes emptiness)

### A2.2.2 — Svalakṣaṇa and the Criterion of Reality

- **Buddhist Epistemology:** N_BE_13 (Svalakṣaṇa) — the unique particular. Per Dharmakīrti: (a) has power to produce effects (arthakriyākāritva), (b) is specific (asādhāraṇa), (c) is not denotable by a word (śabdasyāviṣaya), (d) is apprehensible without depending upon other factors. N_BE_22 (Arthakriyā) — "That which is able to perform a function exists ultimately." Only objects able to participate causally in producing phenomena are real.
...
**Relevant edges:**
- ED_BE_32: N_BE_13 → N_BE_22 (possesses — the particular possesses causal efficacy)
- ED_BE_05: N_BE_02 → N_BE_13 (apprehends — direct perception apprehends the particular)
- ED_BE_14: N_BE_09 → N_BE_13 (apprehends — non-conceptual perception apprehends the particular)

### A2.2.3 — Sāmānyalakṣaṇa and the Conceptual Superstructure

- **Buddhist Epistemology:** N_BE_14 (Sāmānyalakṣaṇa) — the universal, general characteristic. Per Dharmakīrti: (a) has no power to produce effects, (b) is common to many things, (c) is denotable by a word, (d) is not apprehensible without depending upon other factors such as verbal conventions. The universal is not ultimately real — it is a conceptual construction (vikalpa) superimposed on the particular.
...
**Relevant edges:**
- ED_BE_33: N_BE_14 → N_BE_22 (lacks — the universal lacks causal efficacy)
- ED_BE_06: N_BE_03 → N_BE_14 (apprehends — inference apprehends the universal)
- ED_BE_13: N_BE_08 → N_BE_14 (operates on — conceptual construction operates on the universal)

### A2.2.4 — Apoha and the Empty Nature of Concepts

- **Buddhist Epistemology:** N_BE_15 (Apoha) — Dignāga's theory: "a word expresses its own object through the exclusion of the other [things]." Meaning is conveyed by excluding what something is not (not-non-cow → cow). Concepts have no positive intrinsic content — they function through differential exclusion. Verbal cognition is not an independent pramāṇa but a variety of inference.
...
**Relevant edges:**
- ED_BE_16: N_BE_15 → N_BE_03 (is linguistic variant of — apoha reduced to inference)

### A2.2.5 — Vikalpa and the Imputation of Properties

- **Buddhist Epistemology:** N_BE_08 (Vikalpa/Kalpanā) — conceptualized, categorizing cognition that applies names and classes. The mind superimposes structures like proper names (yadṛcchā-śabda), genus-words (jāti-śabda), quality-words (guṇa-śabda), action-words (kriyā-śabda), and substance-words (dravya-śabda). N_BE_09 (Nirvikalpaka pratyakṣa) — pure perception free from this superimposition.
...
**Relevant edges:**
- ED_BE_15: N_BE_09 → N_BE_08 (contrasted with — non-conceptual perception contrasted with conceptual construction)
- ED_BE_38: N_BE_02 → N_BE_08 (is free from — direct perception is free from conceptual construction)
...
| --- | --- | --- | --- |
| N_BE_11 | Svasaṃvedana (Self-awareness) | Type of perception | Primary anchor: reflexive cognition — the mind's awareness of its own states; the self-certification principle |
| N_BE_10 | Mānasa pratyakṣa (Mental perception) | Type of consciousness | Primary anchor: inner cognition through mental consciousness, independent of external sense faculties |
| N_BE_02 | Pratyakṣa (Direct perception) | Source of knowledge | Primary anchor: immediate cognition — the terminal, non-inferential epistemic event |
| N_BE_06 | Bhrānti (Erroneous cognition) | Epistemic error | Mistaken apprehension — the inversion of reality that consciousness can fall into |
| N_BE_07 | Saṃśaya (Doubt) | Epistemic error | Indecision — the state that motivates the pursuit of certainty through cognition |
| N_BE_23 | Avidyā / Avijjā (Ignorance) | Epistemic obstacle | Fundamental non-knowing — the root obstruction that consciousness must overcome |

## A3.2 — Core Mapping

### A3.2.1 — Svasaṃvedana and the Measurement Problem

- **Buddhist Epistemology:** N_BE_11 (Svasaṃvedana) — every cognition is simultaneously aware of itself. Cognition of blue is also, non-inferentially, an awareness of the cognizing-of-blue. Self-luminous (svaprakāśa), not requiring a second-order act to register the first-order act. Svasaṃvedana is the structural grounding of the entire Pramāṇavāda system: it stops the regress of meta-cognitions and self-certifies every valid cognition without external verification.
...
**Relevant edges:**
- ED_BE_19: N_BE_11 → N_BE_02 (is subtype of — self-awareness is a subtype of direct perception) [uncertain]
- ED_BE_20: N_BE_10 → N_BE_11 (entails — mental perception entails self-awareness) [uncertain]

### A3.2.2 — Measurement as Condition for Manifestation

- **Buddhist Epistemology:** N_BE_02 (Pratyakṣa) — immediate cognition through the senses, prior to inference or conceptual overlay. Dignāga defines it as "devoid of mental construction (kalpanāpodham)." It apprehends the particular (svalakṣaṇa) as pure sensation. Pratyakṣa is the condition under which the particular manifests to a cognizing agent. Without the cognitive act, there is no manifestation of the object-as-known.
...
**Relevant edges:**
- ED_BE_18: N_BE_10 → N_BE_02 (is subtype of — mental perception is a subtype of direct perception)
- ED_BE_20: N_BE_10 → N_BE_11 (entails — mental perception entails self-awareness)

### A3.2.4 — Error, Doubt, and Ignorance

- **Buddhist Epistemology:** N_BE_06 (Bhrānti) — mistaken apprehension; inversion of the true nature of an object. N_BE_07 (Saṃśaya) — a state of indecision; the pursuit of certainty (nirṇaya) requires some initial doubt as motivation. N_BE_23 (Avidyā) — fundamental non-knowing of the true nature of reality; the root of suffering and cyclic existence. These three form the negative space around valid cognition: error is wrong cognition, doubt is absent cognition, ignorance is the structural precondition for both.
...
**Relevant edges:**
- ED_BE_27: N_BE_23 → N_BE_06 (causes — ignorance causes erroneous cognition)
- ED_BE_28: N_BE_23 → N_BE_07 (gives rise to — ignorance gives rise to doubt) [uncertain]
- ED_BE_37: N_BE_07 → N_BE_27 (motivates — doubt motivates inductive reasoning) [uncertain]
...
| --- | --- | --- | --- |
| N_BE_26 | Dvisatya (Two truths) | Ontology–cognition | Primary anchor: the two-tier epistemic framework |
| N_BE_03 | Anumāna (Inference) | Source of knowledge | Primary anchor: indirect cognition operating on the universal — the conventional tier's primary instrument |
| N_BE_27 | Svārthānumāna (Inductive reasoning) | Logic | "Inference for oneself" — the private, psychologically real form of inference |
| N_BE_28 | Parārthānumāna (Deductive reasoning) | Logic | "Inference for others" — the public, communicable, contestable form of inference |
| N_BE_24 | Prajñā / Paññā (Wisdom) | Liberation | Penetrating insight into ultimate reality — the cognitive instrument of the ultimate tier |
| N_BE_12 | Yogipratyakṣa (Yogic perception) | Type of perception | Direct, supra-ordinary perception accessing ultimate reality through cultivated faculty |
| N_BE_30 | Pramāṇabhūta (Means of valid cognition) | Foundation | The Buddha as possessor of ultimate valid knowledge — the ideal epistemic agent |
| N_BE_04 | Āgama / Śabda (Testimony) | Source of knowledge | Knowledge from reliable authority — reduced to inference by Dignāga; conventional knowledge |

## A4.2 — Core Mapping

### A4.2.1 — The Two Truths as Epistemic Tiers

- **Buddhist Epistemology:** N_BE_26 (Dvisatya) — Conventional truth (saṃvṛtisat, prajñaptisat): the conceptually constructed phenomenal world. Ultimate truth (paramārthasat, dravyasat): the dynamically subtle, spatio-temporally unstructured, non-conceptual, irreducible reality. These are not two separate worlds — they are two epistemic positions on the same reality. The conventional is not false; it is the way reality appears when filtered through conceptual construction.
...
- ED_BE_02: N_BE_01 → N_BE_03 (includes — pramāṇa encompasses anumāna)
- ED_BE_06: N_BE_03 → N_BE_14 (apprehends — inference apprehends the universal)
- ED_BE_07: N_BE_03 → N_BE_16 (operates through — inference operates through logical sign)
- ED_BE_08: N_BE_03 → N_BE_18 (validated by — inference validated by triple-condition)

### A4.2.3 — Public and Private Inference

- **Buddhist Epistemology:** N_BE_27 (Svārthānumāna) — "inference for oneself." Private, psychologically real. Begins with perceptible observation (darśana) of the sign. The full syllogistic structure need not be made explicit. N_BE_28 (Parārthānumāna) — "inference for others." Public, communicable, contestable. Requires full articulation of pakṣa, hetu, and dṛṣṭānta. Taken in a metaphorical sense (upacāra).
...
**Relevant edges:**
- ED_BE_23: N_BE_27 → N_BE_03 (is subtype of — svārtha is subtype of anumāna)
- ED_BE_24: N_BE_28 → N_BE_03 (is subtype of — parārtha is subtype of anumāna)
- ED_BE_25: N_BE_27 → N_BE_28 (grounds — private inference grounds public syllogism)

### A4.2.4 — Wisdom and Yogic Perception: Access to the Ultimate Tier

- **Buddhist Epistemology:** N_BE_24 (Prajñā) — penetrating insight into the nature of reality; the path out of ignorance. The third of the three trainings: virtue (śīla), concentration (samādhi), and wisdom (prajñā). N_BE_12 (Yogipratyakṣa) — direct, supra-ordinary perception arising from deep meditative cultivation. A mode of transcendental (alaukika) perception not involving external objects and sensory faculties. Accesses the ultimate tier directly, beyond conceptual mediation.
...
**Relevant edges:**
- ED_BE_21: N_BE_12 → N_BE_02 (is subtype of — yogic perception is a subtype of direct perception) [uncertain]
- ED_BE_22: N_BE_12 → N_BE_25 (realizes — yogic perception realizes emptiness) [uncertain]
- ED_BE_29: N_BE_24 → N_BE_23 (dispels — wisdom dispels ignorance)
- ED_BE_30: N_BE_24 → N_BE_25 (realizes — wisdom realizes emptiness)

### A4.2.5 — Pramāṇabhūta and Testimony

- **Buddhist Epistemology:** N_BE_30 (Pramāṇabhūta) — the Buddha as possessor of valid method, arguments, meaning, practice, and purpose. Dignāga's guiding principle: one should accept a statement only after testing its validity, not out of reverence. N_BE_04 (Āgama/Śabda) — testimony reduced to inference by Dignāga. Not an independent pramāṇa.
...
**Relevant edges:**
- ED_BE_36: N_BE_30 → N_BE_01 (is epithet of — pramāṇabhūta as epithet of the Buddha as pramāṇa)
- ED_BE_17: N_BE_04 → N_BE_03 (reduced to — testimony reduced to inference)
...
**Note:** Edges spanning multiple axioms (e.g., ED_BE_01 under Axiom 1 and 3) are listed with both assignments. Their primary treatment is in the first-listed axiom.
...
| --- | --- | --- | --- | --- |
| BIAN-1 | Mānasapratyakṣa (Mental perception) | N_BE_10 | T1.05 | QM has no account of the representational transition between physical detection and symbolic readout. The gap between click and number is outside the formalism. |
| BIAN-2 | Svasaṃvedana (Self-awareness) | N_BE_11 | T1.06 | The deepest asymmetry. QM has no self-certifying epistemic layer. The measurement problem is the consequence: without reflexive cognition, the registration chain has no formal stopping point. |
| BIAN-3 | Yogipratyakṣa (Yogic perception) | N_BE_12 | T1.07 | QM has no formal category for observation through a qualitatively different faculty. All observers are formally equivalent; there is no spectrum of observer types. |
...
| BIAN-7 | Non-conceptual stratum of pratyakṣa | N_BE_02 | T1.02 | Pratyakṣa is non-conceptual by definition. An eigenvalue readout is already a number — a symbolic, conceptual object. No QM concept maps to pratyakṣa at its deepest pre-conceptual level. |
...
| --- | --- | --- | --- | --- |
| 1 | Pratītyasamutpāda | N_BE_29, N_BE_21, N_BE_20, N_BE_01, N_BE_19, N_BE_16, N_BE_18, N_BE_17 | Relational QM, no absolute state, entanglement | BIAN-6 |
| 2 | Śūnyatā | N_BE_25, N_BE_13, N_BE_14, N_BE_22, N_BE_05, N_BE_15, N_BE_08, N_BE_09 | Contextuality, Bell's theorem, properties-as-relations | — |
| 3 | Vijñaptimātra | N_BE_11, N_BE_10, N_BE_02, N_BE_06, N_BE_07, N_BE_23 | Collapse as epistemic update, measurement as condition | BIAN-1, BIAN-2, BIAN-4, BIAN-5, BIAN-7 |
| 4 | Dvisatya | N_BE_26, N_BE_03, N_BE_27, N_BE_28, N_BE_24, N_BE_12, N_BE_30, N_BE_04 | Quantum-classical cut as epistemic boundary | BIAN-3 |
