...
**English:** This document is the third independent case validation for E18 "Delayed-Choice Registration Boundary," required by promotion gate G4 per [vvv_qmrf_framework_e18..._narrow_draft.md Section 8](file:///c:/Stable_Diffusion/Buddhist_Epistemology_Quantum_Measurement/documents/research_documents/framework/drafts/vvv_qmrf_framework_e18_delayed_choice_registration_boundary_narrow_draft.md#L208). Two prior validations have passed: Wheeler delayed-choice interferometer (binary `{W_path, W_interference}`) and Scully-Drühl quantum eraser (ternary `{W_signal_raw, W_which_path, W_erased_interference}`). This case tests E18 against Kim et al. 1999 "Delayed Choice Quantum Eraser" (PRL 84, 1-5), which exhibits **four-branch multi-detector lock with symmetric erased pair** — a structurally stronger stress test than either prior case.
...
| Narrow draft | [vvv_qmrf_framework_e18..._narrow_draft.md](file:///c:/Stable_Diffusion/Buddhist_Epistemology_Quantum_Measurement/documents/research_documents/framework/drafts/vvv_qmrf_framework_e18_delayed_choice_registration_boundary_narrow_draft.md) | Source of refined `Lock(C_f, S, {W_i}) → W_valid` formula and G1-G7 promotion gate definitions |
...
- **Narrow draft:** [vvv_qmrf_framework_e18_delayed_choice_registration_boundary_narrow_draft.md](file:///c:/Stable_Diffusion/Buddhist_Epistemology_Quantum_Measurement/documents/research_documents/framework/drafts/vvv_qmrf_framework_e18_delayed_choice_registration_boundary_narrow_draft.md) — Section 6 supplies symbol table; Section 8 defines G4 promotion gate.
